  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div
        ...
        className={`
          ...
          ${isDragActive
            ...
            : files.length > 0
              ? 'border-zinc-700/60 bg-zinc-900/60 hover:border-amber-500/50'
              : 'border-zinc-700 bg-zinc-900 hover:border-amber-500/60 hover:bg-zinc-900/80'
          }
        `}
      >
        <input {...getInputProps()} />
        ...
        <div className={`
          ...
          ${isDragActive
            ...
            : 'bg-zinc-800 ring-zinc-700 group-hover:bg-amber-500/10 group-hover:ring-amber-500/30'
          }
        `}>
          <UploadCloud className={`h-5 w-5 transition-colors duration-300 ${
            isDragActive ? 'text-amber-400' : 'text-zinc-500 group-hover:text-amber-400'
          }`} />
        </div>
      ...
      {files.length > 0 && (
        <div className="flex items-center justify-between pt-1">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 px-4 py-2.5 text-sm font-medium text-white shadow-md shadow-amber-500/20 transition-opacity hover:opacity-90"
          >
      ...
      <div className="flex items-center justify-center gap-1.5">
        <Lock className="h-3 w-3 text-green-500/70 shrink-0" />
